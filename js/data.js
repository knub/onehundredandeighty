...
var data = {
	...
	designthinkingeinfuehrung: {
		...
		lehrform: ["Seminar", "Projekt"],
		modul: ["Softskills"],
		semester: ["SS11", "WS11/12", "SS12", "WS12/13"],
		benotet: false,
		pflicht: false,
		empfohlen: "",
		vertiefung: [""],
	...
	fachenglisch1: {
		...
		lehrform: ["Seminar"],
		modul: ["Softskills"],
		semester: ["WS10/11", "SS11", "WS11/12", "SS12", "WS12/13"],
		benotet: false,
		pflicht: false,
		empfohlen: "",
		vertiefung: [""],
	...
	hciproject: {
		...
		lehrform: ["Seminar", "Projekt"],
		modul: ["Vertiefungsgebiete"],
		semester: ["WS10/11", "WS11/12", "SS12", "WS12/13"],
		benotet: true,
		pflicht: false,
		empfohlen: "",
		vertiefung: ["HCT", "SAMT"],
